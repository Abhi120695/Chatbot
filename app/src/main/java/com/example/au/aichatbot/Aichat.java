package com.example.au.aichatbot;
...
/**
 * Created by Abhishek upadhyay on 16-09-2016.
 */
public class Aichat {
    ...
    public String get_input(String Input) throws Exception
    {
    ...
    public static boolean similar_input()  {
        Log.v("tag2",sPrevInput+"fuck"+sInput);
